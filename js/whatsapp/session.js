...
import { $, nextFrame, wait } from "../shared/dom.js?v=1.7.2";
import { exceedsCompatLimit, fileTooLargeMessage } from "../shared/compat.js?v=1.7.2";
import { baseName } from "../shared/media-types.js?v=1.7.2";
import { ISSUES_URL, state } from "./state.js?v=1.7.2";
import { buildMediaStore, cleanupMediaStore, closeMediaModal, lazyMedia } from "./media.js?v=1.7.2";
import { parseChatData, parseChatDataFromEntry } from "./parser.js?v=1.7.2";
import { populateSenderFilter, resetSenderFilterUI } from "./filter.js?v=1.7.2";
import {
    isPersistentStorageEnabled,
    markStoredImportOpened,
    persistCurrentImport,
    renderStoredImports
} from "./persistence.js?v=1.7.2";
import { collectExportMessages, renderChatList, scrollToBottom } from "./render.js?v=1.7.2";
import { setSearchEmptyState, toggleSearch, updateSearchCounter } from "./search.js?v=1.7.2";
import { generateStats } from "./stats.js?v=1.7.2";
import {
    closeMenu,
    isMobileLayout,
    playChatRevealOnce,
