...
import { formatBytes, labelForMediaKind } from "../shared/media-types.js?v=1.7.3";
...
import { BATCH_SIZE, MAX_RENDERED_ITEMS, state } from "./state.js?v=1.7.3";
import { formatDateLabel, formatMessageTime } from "./format.js?v=1.7.3";
