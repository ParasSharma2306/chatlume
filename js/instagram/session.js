...
import { $, q, replayClass } from "../shared/dom.js?v=1.6.2";
import { exceedsCompatLimit, fileTooLargeMessage } from "../shared/compat.js?v=1.6.2";
import { clearMediaStore } from "../shared/media-urls.js?v=1.6.2";
import { fixMojibake } from "./mojibake.js?v=1.6.2";
import { igState } from "./state.js?v=1.6.2";
import { cleanupZip, lazyMedia } from "./media.js?v=1.6.2";
import { buildMediaStore, findThreads, folderLabel, initialsFor, parseMessages, sortMessageFiles } from "./parser.js?v=1.6.2";
import { collectExportMessages, renderChatList, scrollToBottom } from "./render.js?v=1.6.2";
import { showThreadSelector } from "./threads.js?v=1.6.2";
import {
    closeMenu,
    generateStats,
    isMobileLayout,
